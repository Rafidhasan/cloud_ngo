                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <ul class="mt-3" style="font-size: 20px">
                        ...
                        <div class="col-md-3">
                            ...
                            <ul class="mt-4" style="font-size: 20px">
                                ...
                                <li><strong>Business Address: </strong>{{ $user->business_Address }}</li>
                                <li><strong>Business Type: </strong>{{ $user->business_type }}</li>
                                <li><strong>Contact Number of Business: </strong>{{ $user->contact_business }}</li>
                                <li><strong>Experience in Business: </strong>{{ $user->exp_business }}</li>
                                <li><strong>Business Capital: </strong>{{ $user->capital }}</li>
                                <li class="mt-5">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="/admin/approveBusinessLoan/loan/{{ $user->user_id }}/{{ $user->token }}" class="btn btn-sm btn-success">Approve</a>
                                        </div>
                                        <div class="col-md-6">
                                            <a href="/admin/rejectBusinessloan/loan/{{ $user->user_id }}/{{ $user->token }}" class="btn btn-sm btn-danger">Reject</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
